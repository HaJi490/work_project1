...
function Login() {
  ...
  return (
    <div className="login-bg">
      ...
      {/* src={logoImg} */}
        <img  alt="UserFlow Logo" className="login-logo-img" />
      ...
      <form className="login-card" onSubmit={handleLogin}>
        ...
        <button className="login-social-btn google" type="button" onClick={() => { window.location.href = "http://localhost:8080/oauth2/authorization/google"; }}
>
        ...
        <button className="login-social-btn naver" type="button" onClick={() => { window.location.href = "http://localhost:8080/oauth2/authorization/naver"; }}>
          {/* src={NaverLogo} */}
          <img  alt="Naver" className="login-social-icon" />
          Naver로 시작하기
        </button>
