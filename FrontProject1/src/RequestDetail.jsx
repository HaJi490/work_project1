      ...
      <div className="request-detail-nocard">
        ...
        <div className="form-grid">
            <div className='info-section'>
                ...
                <input disabled value={detail.name} className="form-info" placeholder="성함" />
            </div>
            <div className='info-section'>
                <span className='info'>기관명</span>
                <input disabled value={detail.organization} className="form-info" placeholder="기관/회사명" />
            </div>
            <div className='info-section'>
                <span className='info'>연락처</span>
                <input disabled value={detail.phone} className="form-info" placeholder="연락처" />
            </div>
            <div className='info-section'>
                <span className='info'>이메일</span>
                <input disabled value={detail.email} className="form-info" placeholder="이메일" />
            </div>
          </div>
